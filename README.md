...
## Klassetrin-niveauer på grundskolefagene

Fire af de fem grundskoletests (kristendomskundskab, dansk, engelsk og matematik) kan nu afgrænses efter klassetrin, ligesom fysiktesten kan vælges i C/B/A-niveau. Vælgeren fungerer på præcis samme måde: den er **kumulativ** – vælger man "Udskoling", får man spørgsmål fra både indskoling, mellemtrin og udskoling; vælger man "Indskoling", får man kun det letteste stof.

| Niveau | Klassetrin |
|---|---|
| Indskoling | 0.–3. klasse |
| Mellemtrin | 4.–6. klasse |
| Udskoling | 7.–9./10. klasse |

Niveauet kan også sættes direkte i adressen, fx `matematik-grundskole.html?niveau=IND`.

**Naturfag har ingen indskolingsspørgsmål.** Naturfag findes som et selvstændigt fag først fra 7. klasse i den danske folkeskole – i 0.–6. klasse hedder faget "Natur/teknologi" og har et andet, enklere indhold (dyr, årstider, enkle forsøg). Den nuværende naturfagsdatabase er skrevet til 7.-9. klasses pensum og er derfor delt i "Mellemtrin" (grundlæggende begreber) og "Udskoling" (beregninger og mere tekniske begreber som Ohms lov, atommodeller og DNA), men reelt dækker begge dele stof, der typisk arbejdes med fra omkring 5.-6. klasse og opefter. Skal der bygges en ægte indskolings-/mellemtrinsudgave, kræver det nyt indhold målrettet "Natur/teknologi"-faget.

### Sådan er spørgsmålene fordelt på niveau

| Fag | Indskoling | Mellemtrin | Udskoling |
|---|---|---|---|
| Naturfag | 0 | 1.151 | 450 |
| Kristendomskundskab | 70 | 524 | 407 |
| Dansk (grundskole) | 102 | 856 | 45 |
| Engelsk (grundskole) | 128 | 828 | 45 |
| Matematik (grundskole) | 88 | 958 | 246 |

Fordelingen er lavet ud fra spørgsmålstype og -indhold (fx er "Plus"/"Minus" med tal under 20 sat til indskoling, mens negative tal og procentregning er udskoling), ikke ved manuel gennemgang af hvert enkelt spørgsmål – så enkelte spørgsmål kan ligge en anelse forkert i forhold til, hvad man selv ville vurdere.
